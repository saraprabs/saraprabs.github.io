const contentData = {
    ...
    projects: `<h1>Projects</h1>
                ...
                <h2>Techstack</h2>
                <p> Frontend- Streamlit, Backend- FastAPI, LLM- Llama 3.2, HuggingFace Embeddings- all-MiniLM-L6-v2, Database- Qdrant </p>
                </div>
                <div class="social-icons">
                                <a href="https://github.com/saraprabs/RAG-Assistant-Chatbot" target="_blank">
                                    <img src="logos/github.png" alt="GitHub">
                                </a>
                                </div> 
                <div>
                ...
                <div>
                <h1>Deep Learning- Object Detection Using YOLO</h1>
